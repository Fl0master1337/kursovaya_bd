...
def get_table_data(cursor, table_name, table_headers, where_clause="", order_clause="", limit_clause=""):
    ...
    return result_itemlist, count, query
...
def initialize_main_window(cursor, settings, current_table, all_tables,
    ...
    table_data, table_count, query = get_table_data(cursor, current_table,
    ...
    layout = [
              ...
              [SG.Combo(all_tables, default_value=current_table, enable_events=True, key='table_choose'),
               SG.VerticalSeparator(),
               ...
               SG.Combo(table_header, default_value=table_header[0], size=(15, 1), pad=(5, 0), key='where_column'),
              ...
              [SG.Text('Table row count: '+str(table_count)), SG.Text('Query: '+query, size=(100, 0))],
              table,
              [SG.HorizontalSeparator()],
              [SG.Button('INSERT', pad=((0, 0), (5, 5)), size=(10, 0))],
              [SG.Input(size=(18, 1), pad=(0, 0), readonly=True,
              ...
              [SG.Button('UPDATE', pad=((0, 5), (5, 5)), size=(10, 0)),
               SG.Combo(table_header, default_value=table_header[0], pad=((0, 5), (5, 5)), key='update_key'),
               SG.Combo(where_operators, default_value=where_operators[0], pad=((0, 5), (5, 5)), key='update_op'),
              ...
              [SG.Button('DELETE', pad=((0, 5), (5, 5)), size=(10, 0)),
               ...
               SG.Combo(where_operators, default_value=where_operators[0], pad=((0, 5), (5, 5)), key='delete_op'),
